...
router.post('/patient/appointments',auth(AuthUser.PATIENT), AppointmentController.getPatientAppointmentById);
...
router.post('/doctor/patients', AppointmentController.getDoctorPatients);
