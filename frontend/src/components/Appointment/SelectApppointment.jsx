...
const SelectApppointment = ({ selectedDate, handleDateChange, selectTime, setSelectTime }) => {
    ...
    const last5Days = Array.from({ length: 7 }, (_, index) =>
                    ...
                    <div className="col-md-3 col-sm-12 mt-3 info-part border-end">
                        ...
                        <div className='icon-box'>
                            ...
                            <div className='d-flex gap-3'>
                                ...
                                <p>Pune Maharastra<br /><span className="form-text">1020BD, Amertam, NorthEast,Srimongol</span></p>
                            </div>
                            <div className='d-flex gap-3'>
                        ...
                        <div className='info-date-card row'>
                            {
                                last5Days.map((item, index) => (
                                    <div key={index + 10} className="mb-3 col-md-6" onClick={() => handleDateChange(item)}>
